...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './books.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOOKS actions', async () => {
      const expectedActions = [
        {
